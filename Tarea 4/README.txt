...
-Para terminar el programa se debe ingresar un 0 cuando todos los clientes se hayan
retirado, así Juan se puede retirar (se demora un poco ya que debe terminar su while).